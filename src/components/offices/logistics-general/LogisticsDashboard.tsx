...
const LogisticsDashboard: React.FC<LogisticsDashboardProps> = ({ user, activeSection }) => {
  ...
  const stockData = [
    { name: 'Bureautique', value: 45, color: '#3B82F6' },
    { name: 'Technique', value: 30, color: '#10B981' },
    { name: 'Informatique', value: 15, color: '#F59E0B' },
    { name: 'Mobilier', value: 10, color: '#EF4444' }
  ];

  const equipmentData = [
    { name: 'Fonctionnel', value: 76, color: '#10B981' },
    { name: 'Maintenance', value: 8, color: '#F59E0B' },
    { name: 'Panne', value: 5, color: '#EF4444' }
  ];
  ...
  const stockItems = [
    { id: 1, nom: 'Papier A4', quantite: 150, seuil: 50, statut: 'normal', categorie: 'Bureautique', prix: 2500, fournisseur: 'Papeterie Centrale' },
    { id: 2, nom: 'Cartouches d\'encre', quantite: 12, seuil: 20, statut: 'faible', categorie: 'Bureautique', prix: 15000, fournisseur: 'Tech Supply' },
    { id: 3, nom: 'Matériel topographique', quantite: 0, seuil: 5, statut: 'rupture', categorie: 'Technique', prix: 250000, fournisseur: 'Geo Equipment' },
    { id: 4, nom: 'Fournitures de bureau', quantite: 85, seuil: 30, statut: 'normal', categorie: 'Bureautique', prix: 5000, fournisseur: 'Office Pro' },
    { id: 5, nom: 'Ordinateurs portables', quantite: 8, seuil: 10, statut: 'faible', categorie: 'Informatique', prix: 450000, fournisseur: 'Computer World' }
  ];

  const equipments = [
    { id: 1, nom: 'Ordinateur Bureau 01', type: 'Informatique', statut: 'fonctionnel', maintenance: '2024-03-15', localisation: 'Bureau DG', responsable: 'Jean Mballa' },
    { id: 2, nom: 'Imprimante HP LaserJet', type: 'Bureautique', statut: 'maintenance', maintenance: '2024-01-20', localisation: 'Secrétariat', responsable: 'Marie Nguema' },
    { id: 3, nom: 'Théodolite Leica', type: 'Topographie', statut: 'fonctionnel', maintenance: '2024-02-10', localisation: 'Bureau Technique', responsable: 'Paul Essomba' },
    { id: 4, nom: 'Véhicule de service', type: 'Transport', statut: 'panne', maintenance: '2024-01-18', localisation: 'Parking', responsable: 'Service Maintenance' }
  ];
            ...
            <tbody>
              {stockItems.filter(item => 
                ...
                <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-gray-900">{item.prix.toLocaleString()} FCFA</td>
