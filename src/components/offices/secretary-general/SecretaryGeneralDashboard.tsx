...
const SecretaryGeneralDashboard: React.FC<SecretaryGeneralDashboardProps> = ({ user, activeSection }) => {
  ...
  const courrierData = [
    { name: 'Entrants', value: 28, color: '#3B82F6' },
    { name: 'Sortants', value: 17, color: '#10B981' },
    { name: 'Urgents', value: 5, color: '#EF4444' }
  ];
  ...
  const courriers = [
    { id: 1, expediteur: 'Direction Générale', objet: 'Rapport mensuel des activités', date: '2024-01-20', statut: 'urgent', type: 'entrant' },
    { id: 2, expediteur: 'Ministère des Domaines', objet: 'Nouvelle réglementation foncière', date: '2024-01-19', statut: 'normal', type: 'entrant' },
    { id: 3, expediteur: 'Client VIP', objet: 'Demande de rendez-vous', date: '2024-01-18', statut: 'traite', type: 'entrant' },
    { id: 4, expediteur: 'GeoCasa Group', objet: 'Convocation assemblée générale', date: '2024-01-17', statut: 'envoye', type: 'sortant' }
  ];

  const evenements = [
    { id: 1, titre: 'Réunion Direction Générale', date: '2024-01-25', heure: '09:00', lieu: 'Salle de conférence', statut: 'planifie', participants: 8 },
    { id: 2, titre: 'Formation équipe commerciale', date: '2024-01-26', heure: '14:00', lieu: 'Salle formation', statut: 'confirme', participants: 12 },
    { id: 3, titre: 'Audit interne', date: '2024-01-27', heure: '10:00', lieu: 'Bureau audit', statut: 'en_cours', participants: 4 }
  ];
            ...
            <tbody>
              {courriers.filter(courrier => 
                ...
                <tr key={courrier.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-gray-600">{courrier.date}</td>
                  <td className="py-3 px-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                      courrier.type === 'entrant' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'
                    }`}>
                      {courrier.type}
                    </span>
                  </td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-green-50 rounded-xl p-4 border border-green-200">
            <div className="text-center">
              <p className="text-2xl font-bold text-green-800">{stats.evenements.total}</p>
              <p className="text-sm text-green-600">Total événements</p>
            </div>
          </div>
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
            <div className="text-center">
              <p className="text-2xl font-bold text-blue-800">{stats.evenements.semaine}</p>
              <p className="text-sm text-blue-600">Cette semaine</p>
            </div>
          </div>
          <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
            <div className="text-center">
              <p className="text-2xl font-bold text-purple-800">{stats.evenements.planifies}</p>
              <p className="text-sm text-purple-600">Planifiés</p>
            </div>
          </div>
          <div className="bg-orange-50 rounded-xl p-4 border border-orange-200">
            <div className="text-center">
              <p className="text-2xl font-bold text-orange-800">{stats.evenements.mois}</p>
